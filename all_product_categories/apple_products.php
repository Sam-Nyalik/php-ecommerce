            ...
            <?php foreach ($database_apple_products as $apple_products) : ?>
                <div class="col-md-3">
                    <a href="index.php?page=individual_product&id=<?= $apple_products['id']; ?>">
                        <div class="card">
                            <div>
                                <img src="<?= $apple_products['productImage1']; ?>" alt="<?= $apple_products['productName']; ?>" class="img-fluid card-img-top">
                            </div>
                            <div class="card-body">
                                ...
                                <?php if ($apple_products['productRetailPrice'] > 0) : ?>
                                    <small class="text-muted"><s style="font-size: 16px">Ksh. <?= $apple_products['productRetailPrice']; ?></s></small>
                                <?php endif; ?>
                                <h6 class="text-dark" style="font-weight: 600;">Ksh. <?= $apple_products['productPrice']; ?></h6>
                            </div>
                        </div>
                    </a>
                </div>
