                        ...
                        if ($stmt->rowCount() == 1) {
                            if ($row = $stmt->fetch()) {
                                ...
                                if (password_verify($password, $hashed_password)) {
                                    ...
                                    $sql = $pdo->prepare("UPDATE users SET userIP = '$user_ip', success = '1'");
                                    $sql->execute();
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form action="index.php?page=user/login" method="post" class="login-form">
                    <!-- Email Address -->
                    ...
                    <!-- Forgot Password -->
                    <div class="form-group">
                        <a href="index.php?page=user/account/email_verification" style="text-align: right; text-decoration: none;">
            ...
            <div class="col-md-6">
                ...
                <a href="index.php?page=user/register"><button class="btn w-100">Create Account Via Email</button></a>
            </div>
