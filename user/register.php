...
<div class="container">
    <div class="row my-5">
        <p><a class="text-secondary" href="index.php?page=user/login"><i class="bi bi-arrow-left-circle"></i> Login</a></p>
    </div>
</div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="index.php?page=user/register" method="post" class="login-form">
                    <div class="row">
                        <!-- First Name -->
                    ...
                    <div class="form-group text-center my-4">
                        ...
                        <h6 style="text-transform: uppercase;"><a href="index.php?page=user/login" style="text-decoration: none; color: #335c67">Login</a></h6>
                    </div>
                </form>
            </div>
        </div>
