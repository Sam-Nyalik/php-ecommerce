            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                        ...
                        <?php
                        $sql = $pdo->prepare("SELECT all_products.productImage1 AS productImage, all_products.productName AS productName, orders.* FROM orders JOIN all_products ON all_products.id = orders.product_id WHERE orders.user_id = '" . $_SESSION['id'] . "'");
                        $sql->execute();
                        ...
                        <?php foreach ($database_user_order_history as $user_order_history) : ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td>Ksh. <?= $user_order_history['product_grand_price']; ?></td>
                                    <td>
                                        <?php if ($user_order_history['user_status'] == 1) : ?>
